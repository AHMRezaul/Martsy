...
<div class="hero-image"
     style="font-family: 'Lato', sans-serif; color: #000000;background-image:linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(/martsy/resources/images/termsbg.jpg)">
<div class="hero-text">
    <h1 class="home-header" style="color: rgba(213,213,213,0.79)">Terms & Conditions</h1>
</div>
</div>

<div class="container" style="font-family: 'Teko', sans-serif; font-size: x-large; color: rgb(25,25,25)">
    <p class="lead"><br>
    ...
    <p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the martsy.com
        website (the "Service") operated by Martsy ("us", "we", or "our").</p>
    ...
    <p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the
        terms then you may not access the Service. The Terms and Conditions agreement for Martsy has been created with
        the help of <a href="https://www.freeprivacypolicy.com/free-terms-and-conditions-generator/">FreePrivacyPolicy.com
    ...
    <p>Martsy has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any
        third party web sites or services. You further acknowledge and agree that Martsy shall not be responsible or
        liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with
        use of or reliance on any such content, goods or services available on or through any such web sites or
        services.</p>
    ...
    <p>These Terms shall be governed and construed in accordance with the laws of Bangladesh, without regard to its
